...
const faqs = [
  {
    ...
    answer:
      "Работаем с оцинкованной сталью толщиной от 0,5 до 2,0 мм для стандартных вентиляционных систем, а также с нержавеющей сталью марок AISI 304 и AISI 316 для пищевой промышленности, медицины и химически агрессивных сред.",
  },
  {
