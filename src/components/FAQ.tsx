...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Организуем доставку по Набережным Челнам и другим регионам Татарстана. Работаем с транспортными компаниями для дальних направлений. Самовывоз со склада также возможен. Стоимость и сроки доставки рассчитываются индивидуально.",
  },
  {
